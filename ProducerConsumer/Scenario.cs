...
public class Scenario<T> where T : new()
{
    ...
    private Producer<T> _producer, _producer1;
    private Consumer<T> _consumer, _consumer1;
                    ...
                    int producerDelay, int consumerDelay, Reporter<T>.ReportMode mode)
    {
        ...
        _producer1 = new Producer<T>(_queue);
        _consumer = new Consumer<T>(_queue);
        _consumer1 = new Consumer<T>(_queue);
    ...
    public async Task RunAsync()
    {
        ...
        Task taskProduce1 = Task.Run(() => ProduceWithRandomDelay(_iterations, _producerDelay));
        Task taskConsume1 = Task.Run(() => ConsumeWithRandomDelay(_iterations, _consumerDelay));
